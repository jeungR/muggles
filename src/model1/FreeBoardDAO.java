...
//////////////////////////////////답글////////////////////////////////////
	...
	public int boardReplyOk(FreeBoardTO to){
		...
		try {
			...
			//부모글의 group 정보
			String sql = "select grp, grps, grpl from freeboard where seq=?";
...
/////////////////////////Modify//////////////////////////
		...
		public int boardModifyOk(FreeBoardTO to) {
			...
			try {
				...
				//	////////////////////////////////////////////
				//DB데이터 수정 (파일도 추가 해야함)
				sql = "update freeboard set title=?, writer=?, content=? where seq=? and password=?";
				pstmt = conn.prepareStatement(sql);
				pstmt.setString(1, to.getTitle());
				...
				System.out.println("DAO password = "+to.getPassword());
