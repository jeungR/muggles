...
<%
	...
	//Action에서 데이터 받음
	/* QnaBoardListTO listTO = (QnaBoardListTO)request.getAttribute("listTO");
    ...
    ArrayList<QnaBoardTO> boardList = listTO.getBoardList();
    
    StringBuffer result = new StringBuffer();

    //레코드 데이터 리턴
    for(QnaBoardTO to : boardList){
    	seq = to.getSeq();
       ...
       */
       ...
       ArrayList<QnaBoardTO> lists = (ArrayList)request.getAttribute("lists");  
       

       //ArrayList 데이터 json에 담음
       StringBuffer result_qna = new StringBuffer();
       for(QnaBoardTO to: lists){
           ...
           String wdate = to.getWdate();
           String hit = to.getHit();
           String file1 = to.getFile1();
           
           
           result_qna.append("<tr>");
           result_qna.append("	<td class='hidden-xs seq'>"+seq+"</td>");
           result_qna.append("	<td>");
           ///////////////////////////////수정하 부분 그릠 /////////////////////////////////
           result_qna.append("		<img class='img-rounded' src='demo/img/pictures/1.jpg' height='50'>");
           result_qna.append("	</td>");
           result_qna.append("	<td>");
           /////////////////////////////// 파일 아이콘 수정할 부분. //////////////////////////
           result_qna.append("		"+title+"");
         	/* 
           //첨부파일 이미지
           if(!file1.equals("")) {
               result.append("<i class='glyphicon glyphicon-paperclip'></i>");
           }
            */
            result_qna.append("	</td>");
            result_qna.append("	<td class='hidden-xs'>");
            result_qna.append("		<p class='no-margin'>");
            result_qna.append("			<small>");
            result_qna.append("				<span class='fw-semi-bold'>주제:</span>");
            result_qna.append("				<span class='text-semi-muted'>&nbsp; "+header1+"</span>");
            result_qna.append("			</small>");
            result_qna.append("		</p>");
            result_qna.append("		<p>");
            result_qna.append("			<small>");
            result_qna.append("				<span class='fw-semi-bold'>언어:</span>");
            result_qna.append("				<span class='text-semi-muted'>&nbsp; "+header2+"</span>");
            result_qna.append("			</small>");
            result_qna.append("		</p>");
            result_qna.append("	</td>");
            result_qna.append("	<td class='hidden-xs text-semi-muted'>");
            result_qna.append("		"+wdate+"");
            result_qna.append("	</td>");
            result_qna.append("	<td class='text-semi-muted'>");
            result_qna.append("		<span class='label label-danger'>답변완료</span>");
            result_qna.append("	</td>");
            result_qna.append("	<td class='hidden-xs width-150'>");
            result_qna.append("		<div class='progress mt-xs js-progress-animate'>");
            result_qna.append("			<div class='progress-bar progress-bar-success' data-width='29%' style='width: 0;''>"+hit+"</div>");
            result_qna.append("	</div>");
            result_qna.append("	</td>");
            result_qna.append("</tr>");
...
<div class="content-wrap">
    ...
    <main id="content" class="content" role="main">
        ...
        <h1 class="page-title">Open - <span class="fw-semi-bold">Question</span></h1>
        <div class="row">
            <div class="col-md-12">
                <section class="widget">
                    <header>
                        <h4>
                            <span class="fw-semi-bold">질문게시판</span>
                        </h4>
                    ...
                    <div class="widget-body">
                    	<p>이곳은 공개 질문게시판입니다. 수업에 관련된 질문과 학원문의사항 등을 올려주세요</p>
                        <div class="mt">
	                        <table id="datatable-table" class="table table-hover">
	                            <thead>
	                            <tr>
	                                <th class="hidden-xs">#</th>
	                                <th class="no-sort">사진</th>
		    ...
		    <div class="modal-dialog modal-lg">
		        <div class="modal-content">
		            <div class="modal-header">
		                ...
		                <h4 class="modal-title text-align-center fw-bold mt" id="myModalLabel18">공개 질문게시판 글쓰기</h4>
		                <p class="text-align-center fs-mini text-muted mt-sm">
		                    	공개 질문게시판입니다. 수업에 관련된 질문과 학원문의사항 등을 올려주세요
		                </p>
		            </div>
		            <div class="modal-body bg-gray-lighter">
		                    <div class="row">
		                    <form id="validation-form" class="form-label-left mt" enctype="multipart/form-data" method="post"
		                      action="open_qna_write_ok_ok.do"
		                         ...
		                         <div class="form-group">
		                            ...
		                            <div class="col-sm-8">
		                                <select id="country-select"
		                                    ...
		                                    <option value="ABAP"> <i class="fa fa-desktop"></i>ABAP</option>
...
<!-- page specific js -->
<script src="js/open_qna.js"></script>
</body>
</html>