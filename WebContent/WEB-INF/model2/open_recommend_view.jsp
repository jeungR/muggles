...
Recommend_Tab_Dto dto = (Recommend_Tab_Dto)request.getAttribute("dto");

int recomm_seq =dto.getRecomm_seq();
String recomm_content = dto.getRecomm_content();
String recomm_title = dto.getRecomm_title();
String wuser_name = dto.getUser_name();
String wuser_seq = dto.getUser_seq();
String recomm_olin = dto.getRecomm_olin();
String cost = dto.getCst();
String recomm_link = dto.getRecomm_link();
String recomm_laguage =dto.getRecomm_language();
System.out.println(wuser_seq);
System.out.println(recomm_seq);
...
<div class="content-wrap">
    ...
    <main id="content" class="content" role="main">
        ...
        <h1 class="page-title hidden-print">Recommend - <span class="fw-semi-bold">Site</span></h1>
        <div class="row">
        	<!-- 뒤로가기 버튼 -->
        	<div class="col-md-12 hidden-print" style="height:35px;">
        		<a class="btn btn-default btn-sm width-50 pull-left" id="back-btn" href="open_recommend.do">
                    ...
                    <header>
                        <div class="row">
                            <div class="col-sm-9 col-print-9">
                                <span class="icon fa-2x"><i class="glyphicon glyphicon-th-list"></i> </span><span class="fa-lg">생활코딩</span>
                            </div>
                            <div class="col-sm-3 col-print-3">
                                <h4 class="text-align-right">
                                    #<span class="fw-semi-bold"><%=recomm_seq %></span> / <small><%=wuser_name %></small>
                                </h4>
                            </div>
                        </div>
                    </header>
                    <div class="widget-body">
                        ...
                        <div class="row mb-lg">
                            <section class="col-sm-12 col-print-12">
                                <h4 class="text-muted no-margin mb-sm">추천사이트 정보</h4>
                                <address>
                                    <strong><i class="glyphicon glyphicon-usd mb-xs"></i> <%=cost %></strong><br>
                                    <i class="fa fa-file-code-o mb-xs"></i> <%=recomm_laguage %><br>
                                    <i class="glyphicon glyphicon-facetime-video mb-xs"></i> <%=recomm_olin %><br>
                                    <abbr title="Work url">url:</abbr> <a href="<%=recomm_link%>"><%=recomm_link %></a><br>
                                </address>
                            </section>
                        </div>
                        <div class="row">
		    ...
		    <div class="modal-dialog modal-sm">
		        <div class="modal-content">
		            <div class="modal-header">
		                ...
		                <h4 class="modal-title text-align-center fw-bold mt" id="myModalLabel18">추천사이트 글삭제</h4>
		...
		<div class="modal fade" id="myModal_mod_pw" tabindex="-1" role="dialog" aria-labelledby="myModal_mod_pw" aria-hidden="true">
		    <div class="modal-dialog modal-sm">
		        <div class="modal-content">
		            <div class="modal-header">
		                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		                <h4 class="modal-title text-align-center fw-bold mt" id="myModalLabel18">추천사이트 글수정</h4>
		                <p class="text-align-center fs-mini text-muted mt-sm">
		                    	비밀번호를 입력하세요
		                </p>
		            </div>
		...
		<div class="modal fade" id="myModal_mod" tabindex="-1" role="dialog" aria-labelledby="myModal_mod" aria-hidden="true">
		    <div class="modal-dialog modal-lg">
		        <div class="modal-content">
		            ...
		            <div class="modal-body bg-gray-lighter">
		               <div class="row">
		               <form id="validation-form3" class="form-label-left mt" method="post"
		                 data-parsley-priority-enabled="false"
		                 novalidate="novalidate">
		                   <fieldset>
		                    <div class="form-group">
		                    ...
		                    <div class="form-group">
		                   	...
		                   	<div class="form-group">
		                           ...
		                           <div class="col-sm-8">
		                               <input type="text" id="title" name="title" class="form-control" placeholder="부분 유료일 경우 상세내용을 적어주세요"
		                               	data-parsley-trigger="change"
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="col-sm-8">
		                            ...
		                            <span class="help-block">추천하고싶은 사이트를 대표할만한 이미지를 올려주세요.</span>
		                        </div>
		                    </div>
		                   	<div class="form-group">
		                           <div class="col-sm-12">
...
<!-- page specific js -->
<script src="js/open_recommend_view.js"></script>
</body>
</html>