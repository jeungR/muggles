...
<%
	...
	System.out.println("jsp1 " + id);
	System.out.println("jsp2 " +user_seq);
...
<div class="content-wrap">
    ...
    <main id="content" class="content" role="main">
        ...
        <h1 class="page-title">Study - <span class="fw-semi-bold">Board</span></h1>
        <div class="clearfix">
        <div class="btn-group pull-right">
            <button class="btn btn-default width-100 mb mt-n-lg write_btn" role="button" data-toggle="modal" data-target="#myModal18"><!-- 클릭하면 모달뜸 -->
			    <span class="circle bg-white">
        ...
        <div class="row" id="open_study_list_json" >
            <!-- 스터디 위젯 -->
            <!-- -->
            </div>
        </div>
        <!-- 페이지네이션 -->
      <div class="text-align-center" id="#stu_board_paging">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title text-align-center fw-bold mt" id="write">스터디게시판 글쓰기</h4>
                              ...
                              novalidate="novalidate" >
                                <fieldset>
                                	...
                                	<div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="location" name="title" class="form-control" placeholder="스터디 모임 장소를 적어주세요"
                                	...
                                	<div class="form-group">
                                        <div class="col-sm-12">
                                            <input type="text" id="stu_title" name="title" class="form-control"
                                                   placeholder="제목" required="required">
                               </div>
                                    </div>
                                    <div class="form-group">    
		                                <div class="col-md-12">
		                                    <textarea rows="20" id="wysiwyg-study" name="content" class="form-control" 
		                                        data-parsley-trigger="change"
	                            ...
	                            <div class="modal-footer form-actions">
			                        ...
			                        <button type="button" class="btn btn-success" id="stu_write" idx="<%=user_seq %>">Save changes</button>
			                    </div> 
	                            </form>
                            </div>
                    </div>
...
<!-- page specific js -->
<script src="js/open_study.js"></script>
