...
<%
       ...
       ArrayList<Class1_Question_BoardTO> lists = (ArrayList)request.getAttribute("lists");  
       

       //ArrayList 데이터 json에 담음
       StringBuffer result_qna = new StringBuffer();
       for(Class1_Question_BoardTO to: lists){
    	...
    	result_qna.append("					<tr>");
   		...
   		result_qna.append("						<img class='img-rounded' src='demo/img/pictures/1.jpg' alt='' height='50'>");
   		result_qna.append("						</td>");
   		result_qna.append("						<td><a href='priv_qna_view.do?seq="+seq+"'>"+title+"</a></td>");
        ...
        result_qna.append("							</p>");
        result_qna.append("						</td>");
        result_qna.append("						<td class='hidden-xs text-semi-muted'>"+wdate+"</td>");
...
<div class="content-wrap">
    ...
    <main id="content" class="content" role="main">
        ...
        <h1 class="page-title">Closed - <span class="fw-semi-bold">Question</span></h1>
        <div class="row">
            <div class="col-md-12">
                <section class="widget">
                    <header>
                        <h4>
                            <span class="fw-semi-bold">반별 질문게시판</span>
                        </h4>
                    ...
                    <div class="widget-body">
                    	<p>이곳은 반별 질문게시판입니다. 수업에 관련된 질문과 반별문의사항 등을 올려주세요</p>
                        <div class="mt">
...
<!-- page specific js -->
<script src="js/priv_qna.js"></script>
</body>
</html>