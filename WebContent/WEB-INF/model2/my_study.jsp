...
<div class="content-wrap">
    ...
    <main id="content" class="content" role="main">
        <ol class="breadcrumb">
            <li>YOU ARE HERE</li>
            <li class="active">참여 스터디</li>
        </ol>
        <h1 class="page-title">My - <span class="fw-semi-bold">Study</span></h1>
        <ul id="tabs1" class="nav nav-tabs">
            <!-- 탭 리스트 -->
            <li class="active"><a href="#tab1" data-toggle="tab">자바 스터디</a></li>
            <li class=""><a href="#tab2" data-toggle="tab">HTML 스터디</a></li>
            <li class=""><a href="#tab3" data-toggle="tab">웹디자인</a></li>
        </ul>
        <div id="tabs1c" class="tab-content mb-lg">
            <!-- 탭 본문 1개-->
            <div class="tab-pane active" id="tab1">
                <h3><a href="#">Java - 초보 스터디 열심히 하실분 모집합니다.</a></h3>
                <!-- 스터디 정보 -->
                <div class="row mb-lg">
                    <section class="col-sm-10 col-print-10">
                        <h4 class="text-muted no-margin mb-sm">스터디 정보</h4>
                        <address>
                            <strong><i class="fa fa-map-marker mb-xs"></i> &nbsp; 강남 근처</strong><br>
                            <i class="glyphicon glyphicon-calendar mb-xs"></i><time>월,수,금 / 09.30 - 10.20</time><br>
                            <i class="glyphicon glyphicon-user mb-xs"></i>모집인원 3/5</a><br>
                            <abbr title="Work name">조장 :</abbr> 민광진<br>
