...
<%
    ...
    String header3 =to.getHeader3();
    String header4 =to.getHeader4();
    String writer = to.getWriter();
    String wdate = to.getWdate();
    String password = to.getPassword();
    String hit = to.getHit();
    String content = to.getContent();
    String content2 = to.getContent2();
    
    //
    System.out.println("view jsp seq = "+ to.getSeq());
    System.out.println("view jsp password = "+ to.getPassword());
...
<div class="content-wrap">
    ...
    <main id="content" class="content" role="main">
        ...
        <h1 class="page-title hidden-print">Review - <span class="fw-semi-bold">Board</span></h1>
        <div class="row">
        	<!-- 뒤로가기 버튼 -->
        	<div class="col-md-12 hidden-print" style="height:35px;">
        		<a class="btn btn-default btn-sm width-50 pull-left" id="back-btn" href="close_review.html">
                    ...
                    <div class="widget-body">
                        ...
                        <div class="row mb-lg">
                            <section class="col-sm-12 col-print-12">
                                <h4 class="text-muted no-margin mb-sm">복습글 정보</h4>
                                <address>
                        ...
                        <section>
                        	<div class="col-sm-12 col-print-12">
                                <textarea id="code-mirror-view" name="content2" class="form-control" readonly>
								<!-- 코드가 들어가는 부분 -->
									<%=content2 %>	
                                </textarea>
                            </div>
		    ...
		    <div class="modal-dialog modal-lg">
		        <div class="modal-content">
		            ...
		            <div class="modal-body bg-gray-lighter">
		                    <div class="row">
		                    <form id="validation-form" class="form-label-left mt" method="post"
		                      action="class1_review_modifyok.do"
		                         	...
		                         	<div class="form-group">
				                        <div class="col-md-12">
				                        	<select class="selectpicker mb-sm" data-style="btn-default btn-sm"
	                                                data-width="auto"
	                                                name="header3"
	                                                tabindex="-1" id="code-language-mod">
				                        	...
				                        	<select class="selectpicker" data-style="btn-default btn-sm"
	                                                data-width="auto"
	                                                name="header4"
	                                                tabindex="-1" id="code-tamplate-mod">
	                                            <option value='default'>default</option>
	                                            <option value='dracula'>dracula</option>
											    <option value='cobalt'>cobalt</option>
	                                        </select>
				                            <textarea rows="20" id="code-mirror-mod" name="content-code" class="form-control"><%=content2 %></textarea>
				                        </div>
			                        </div>
		                        </fieldset>
		                        <fieldset class="mt-lg">
		                         <legend>
		                             ...
		                             <div class="form-group">
		                                 ...
		                                 <div class="col-sm-5">
		                                     <input type="password" id="password24" name="password" class="form-control mb-sm"
		                                            data-parsley-trigger="change"
		                                            data-parsley-minlength="6"
		                                            placeholder="비밀번호"
		                                            required="required">
		                                 ...
		                                 <div class="col-sm-4">
		                                     <input type="password" id="password24-r" name="password-r" class="form-control"
		                                            data-parsley-trigger="change"
		                                            data-parsley-minlength="6"
		                                            data-parsley-equalto="#password24"
		                                            placeholder="비밀번호 확인"
		                                            required="required">
		                                 </div>
		                             </div>
...
<!-- page specific js -->
<script src="js/priv_review_view.js"></script>
</body>
</html>