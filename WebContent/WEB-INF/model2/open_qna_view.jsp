...
<div class="content-wrap">
    ...
    <main id="content" class="content" role="main">
        ...
        <h1 class="page-title hidden-print">Open - <span class="fw-semi-bold">Question</span></h1>
        <div class="row">
        	<!-- 뒤로가기 버튼 -->
        	<div class="col-md-12 hidden-print" style="height:35px;">
        		<a class="btn btn-default btn-sm width-50 pull-left" id="back-btn" href="open_qna.do">
                    ...
                    <header>
                        <div class="row">
                            <div class="col-sm-9 col-print-9">
                                <span class="icon fa-2x"><i class="glyphicon glyphicon-th-list"></i> </span><span class="fa-lg"><%=title %></span>
                            </div>
                            <div class="col-sm-3 col-print-3">
                                <h4 class="text-align-right">
                                    #<span class="fw-semi-bold"><%=seq %></span> / <small><%=writer %></small>
                                </h4>
                        ...
                        <div class="row mb-lg">
                            <section class="col-sm-12 col-print-12">
                                ...
                                <address>
                                    ...
                                    <i class="glyphicon glyphicon-asterisk mb-xs"></i> 주제 : <%=header1 %><br>
                                    <i class="fa fa-language mb-xs"></i> 언어 : <%=header2 %><br>
                                    <i class="glyphicon glyphicon-paperclip"></i>첨부파일 : <a href="downloader.do?filename=<%=file1 %>"><%=file1 %></a>
                                </address>
                            </section>
                        </div>
                        <div class="row">
		    ...
		    <div class="modal-dialog modal-sm">
		        <div class="modal-content">
		            <div class="modal-header">
		                ...
		                <h4 class="modal-title text-align-center fw-bold mt" id="myModalLabel18">질문게시판 글삭제</h4>
		            ...
		            <div class="modal-body bg-gray-lighter">
		                    <div class="row">
		                    <form id="validation-form11" class="form-label-left mt" method="post"
		                      action="open_qna_delete_ok.do"
		...
		<div class="modal fade" id="myModal_mod_pw" tabindex="-1" role="dialog" aria-labelledby="myModal_mod_pw" aria-hidden="true">
		    <div class="modal-dialog modal-sm">
		        <div class="modal-content">
		            <div class="modal-header">
		                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		                <h4 class="modal-title text-align-center fw-bold mt" id="myModalLabel18">질문게시판 글수정</h4>
		                <p class="text-align-center fs-mini text-muted mt-sm">
		                    	비밀번호를 입력하세요
		                </p>
		            </div>
		            <div class="modal-body bg-gray-lighter">
		                    <div class="row">
		                    <form id="validation-form21" class="form-label-left mt" method="post"
		                      data-parsley-priority-enabled="false"
		                      novalidate="novalidate">
		                        <fieldset class="mt-lg">
		                             <div class="form-group">
		...
		<div class="modal fade" id="myModal_mod" tabindex="-1" role="dialog" aria-labelledby="myModal_mod" aria-hidden="true">
		    <div class="modal-dialog modal-lg">
		        <div class="modal-content">
		            <div class="modal-header">
		                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		                <h4 class="modal-title text-align-center fw-bold mt" id="myModalLabel18">공개 질문게시판 글수정</h4>
		                <p class="text-align-center fs-mini text-muted mt-sm">
		            ...
		            <div class="modal-body bg-gray-lighter">
		                    <div class="row">
		                    <form id="validation-form91" class="form-label-left mt" enctype="multipart/form-data" method="post"
		                      action="open_qna_modify_ok.do"
		                      data-parsley-priority-enabled="false"
		                      novalidate="novalidate">
		                        <fieldset>
		                        <!-- 추가부분 seq가 없으므로 데이터가 넘어가지 않음 -->
		                             ...
		                             <div class="form-group">
		                                 ...
		                                 <div class="col-sm-9">
		                                     <input type="text" id="writer" name="writer" class="form-control"
		                                            value="<%=writer %>" required="required">
		                                 </div>
		                             </div>
		                             <div class="form-group">
		                                 <label class="control-label col-sm-3" for="password">
		                                 ...
		                                 <div class="col-sm-5">
		                                     <input type="password" id="password22" name="password" class="form-control mb-sm"
		                                            data-parsley-trigger="change"
		                                            data-parsley-minlength="6"
		                                            placeholder="비밀번호"
		                                            required="required">
		                                 ...
		                                 <div class="col-sm-4">
		                                     <input type="password" id="password22-r" name="password-r" class="form-control"
		                                            data-parsley-trigger="change"
		                                            data-parsley-minlength="6"
		                                            data-parsley-equalto="#password22"
		                                            placeholder="비밀번호 확인"
		                                            required="required">
		                                 </div>
		                             </div>
...
<!-- page specific js -->
<script src="js/open_qna_view.js"></script>
</body>
</html>