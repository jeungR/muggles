...
<div class="content-wrap">
    ...
    <main id="content" class="content" role="main">
        <div class="row">
	        ...
	        <h1 class="page-title pull-left">Food <span class="fw-semi-bold">MatZip</span></h1>
        </div>
        <div class="row">
            <div class="col-md-9 col-md-offset-1">
                <section class="widget">
                    <header>
                        <h3>
                            	맛집등록
                            <small><small> 필수 입력 항목을 입력해주세요.</small></small>
                        </h3>
                    ...
                    <div class="widget-body">
                        <form id="validation-form" class="form-horizontal form-label-left mt" method="post"
                            ...
                            <fieldset>
                                <legend>
                                    ...
                                    <input type="hidden" id="map-lat" name="lat" class="form-control" required="required">
                                    <input type="hidden" id="map-lng" name="lng" class="form-control" required="required">
                            </fieldset>
                            <fieldset>
                                <legend>
                                    	맛집 세부사항을 입력해 주세요
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="title">식당명</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                    <label class="control-label col-sm-3" for="wysiwyg">
                                                            식당소개
                                    ...
                                    <div class="col-sm-9">
                                        <textarea rows="15" id="wysiwyg" name="content" class="form-control" 
                            ...
                            <div class="form-actions">
                                ...
                                <a type="button" class="btn btn-default btn-rounded" href="maps_google.html">Cancel</a>
                            </div>
                        </form>
                    </div>
                </section>
...
<script src="http://maps.google.com/maps/api/js?key=AIzaSyBjcU7aVzQOIvfI4gamkw0ukJSlHaVMiZA&sensor=true"></script>
<script src="vendor/gmaps/gmaps.js"></script>
<!-- page specific js -->
<script src="js/open_map_write.js"></script>
</body>
</html>