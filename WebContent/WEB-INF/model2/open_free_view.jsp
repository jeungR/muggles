...
<div class="content-wrap">
    ...
    <main id="content" class="content" role="main">
        ...
        <h1 class="page-title hidden-print">Free - <span class="fw-semi-bold">Board</span></h1>
        <div class="row">
        	<!-- 뒤로가기 버튼 -->
        	<div class="col-md-12 hidden-print" style="height:35px;">
        		<a class="btn btn-default btn-sm width-50 pull-left" id="back-btn" href="open_free.do">
                    ...
                    <header>
                        <div class="row">
                            <div class="col-sm-9 col-print-9">
                                <span class="icon fa-2x"><i class="fa fa-quote-left"></i> </span><span class="fa-lg"><%=title %></span>
                            </div>
		    ...
		    <div class="modal-dialog modal-sm">
		        <div class="modal-content">
		            <div class="modal-header">
		                ...
		                <h4 class="modal-title text-align-center fw-bold mt" id="myModalLabel18">자유게시판 글삭제</h4>
		...
		<div class="modal fade" id="myModal_mod_pw" tabindex="-1" role="dialog" aria-labelledby="myModal_mod_pw" aria-hidden="true">
		    <div class="modal-dialog modal-sm">
		        <div class="modal-content">
		            <div class="modal-header">
		                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		                <h4 class="modal-title text-align-center fw-bold mt" id="myModalLabel18">자유게시판 글수정</h4>
		                <p class="text-align-center fs-mini text-muted mt-sm">
		                    	비밀번호를 입력하세요
		                </p>
		            </div>
		            <div class="modal-body bg-gray-lighter">
		                    ...
		                    <form id="validation-form2" class="form-label-left mt" method="post"
		                     ...
		                     <div class="modal-footer form-actions">
		                   <button type="button" class="btn btn-gray" data-dismiss="modal">Close</button>
		                   <button type="submit" class="btn btn-success" onclick="$('#myModal_mod_pw').modal('hide'); $('#myModal_mod').appendTo('body').modal('show');">Confirm</button><!-- 클릭시 모달 -->
		               </div>
		                     </form>
		                    </div>
		            </div>
		                        ...
		                        <fieldset class="mt-lg">
		                         <legend>
		                             ...
		                             <div class="form-group">
		                                 ...
		                                 <div class="col-sm-5">
		                                     <input type="password" id="password34" name="password" class="form-control mb-sm"
		                                            data-parsley-trigger="change"
		                                            data-parsley-minlength="6"
		                                            placeholder="비밀번호"
		                                            required="required">
		                                 ...
		                                 <div class="col-sm-4">
		                                     <input type="password" id="password34-r" name="password-r" class="form-control"
		                                            data-parsley-trigger="change"
		                                            data-parsley-minlength="6"
		                                            data-parsley-equalto="#password34"
		                                            placeholder="비밀번호 확인"
		                                            required="required">
		                                 </div>
		                             </div>
...
<!-- page specific js -->
<script src="js/open_free_view.js"></script>
</body>
</html>