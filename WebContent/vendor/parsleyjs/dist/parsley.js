...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  defaultMessage: "입력값이 유효하지 않습니다.",
  type: {
    email:        "입력값이 email 형식을 따라야 합니다.",
    url:          "입력값이 url 형식을 따라야 합니다..",
    number:       "입력값이 숫자여야 합니다.",
    integer:      "입력값이 정수여야 합니다.",
    digits:       "This value should be digits.",
    alphanum:     "This value should be alphanumeric."
  },
  notblank:       "입력값이 스페이스를 허용하지 않습니다.",
  required:       "필수 입력 양식입니다.",
  pattern:        "This value seems to be invalid.",
  min:            "입력값이 %s 보다 크거나 같아야 합니다.",
  max:            "입력값이 %s 보다 작거나 같아야 합니다.",
  range:          "입력값이 %s 와 %s 사이에 존재해야 합니다.",
  minlength:      "내용이 너무 짧습니다. 적어도 %s 글자이상 입력하셔야 합니다.",
  maxlength:      "내용이 너무 깁니다. 내용은 %s 글자를 초과할 수 없습니다.",
