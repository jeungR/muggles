...
function initAppFunctions(){
    ...
    !function($){
        ...
        $(document).on('click', '.chat-sidebar-user-group > a', function(){
            ...
            var id = $this.attr('href').toString().substring(1);
        ...
        $('#chat-sidebar-input').keyup(function(e){
            ...
            var chat_id = $('.chat-sidebar-user-group > a').attr('href').toString().substring(1);
            
            $.ajax({
				url: './home_chat_write.do',
				type: 'post',
				dataType: 'json',
				data: 
				{
        		...
        		success: function(data) {
        			...
        			$.each(data, function(index, value) {
        				if (value.sender_id == id) {
        					result += "<li class='message'>";
                           	result += "	<span class='thumb-sm'>";
                           	result += "    	<img class='img-circle' src='" + value.user_photo + "' alt='..'>";
                           	result += "    </span>";
                           	result += "    <div class='message-body'>";
                           	result += 			value.com_text + " (" + value.com_time + ")";
                           	result += "    </div>";
                           	result += "</li>";
        				} else {
        					result += "<li class='message from-me'>";
                           	result += "	<span class='thumb-sm'>";
                           	result += "    	<img class='img-circle' src='" + value.user_photo + "' alt='..'>";
                           	result += "    </span>";
                           	result += "    <div class='message-body'>";
